...
/* Tests whether the line intersects the x-axis, and the abscissa of
   intersection lies in the range [0, h] */
int xinter0(line_t l, int h)
{
	int t;
	...
	if (l.a.y < l.b.y)
		return xinter0(lswap(l), h);

	t = -l.a.y * (l.a.x - l.b.x) + l.a.x * (l.a.y - l.b.y);
printf("[t=%d tmax=%d]",t, h*(l.a.y-l.b.y));
...
{
int r=xinter0(l,h);
printf("xinter((%d,%d)-(%d,%d), h=%d) = %d\n",
	l.a.x, l.a.y, l.b.x, l.b.y, h, r);
return r;
}

/* Tests whether the line intersects the y-axis, and the ordinate of
   intersection lies in the range [0, h] */
...
printf("yinter((%d,%d)-(%d,%d), h=%d) = %d\n",
	l.a.x, l.a.y, l.b.x, l.b.y, h, xinter(m,h));
...
printf("[%d %d %d %d]",
	xinter(ltrans(l, -r.xmin, -r.ymax), r.xmax - r.xmin),
