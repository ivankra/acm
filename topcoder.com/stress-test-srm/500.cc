...
OutputType Execute(InputTuple input) {
	MusicalChairs instance;
	return instance.knockedOut(input.arg1, input.arg2, input.arg3);
}
...
{
	const char *example[] = {
		"{\"Emma Sue\", \"Billy Bob Thornton\", \"Joe\", \"Cassius Clay\"}, \"hh.h\", 1 Returns: \"Billy Bob Thornton\"",
"{\"Emma Sue\", \"Billy Bob Thornton\", \"Joe\", \"Cassius Clay\"}, \"hh.h\", 4 Returns: \"Joe\"",
"{\"Jack Dempsey\", \"Joe Louis\", \"Rocky Marciano\",  \"Cassius Clay\", \"George Foreman\", \"Mike Tyson\"}, \"h.hhhh\", 500 Returns: \"Mike Tyson\"",
"{\"  itchy   \", \"SCRATCHY\"}, \".h\", 0 Returns: \"  itchy   \"",
"{\"Moe\", \"Larry\", \"Curly\", \"Moe\"}, \"hh.h\", 2 Returns: \"Moe\""
