...
struct Scramble {
	...
	string scrambleWord(string text) {
		return text[0] + scramble(text.substr(1, text.size()-2)) + text[text.size()-1];		
	}
};
...
OutputType Execute(InputTuple input) {
	Scramble instance;
	return instance.scrambleWord(input.arg1);
}
...
{
	const char *example[] = {
		"\"alphabet\" Returns: \"aaelphbt\"",
"\"abcdefghijklmnopqrstuvwxyzabcdefghijklmnopqrstuvwx\" Returns: \"aabcdefghijklmnopqrstuvwyzxwvutsrqponmlkjihgfedcbx\"",
"\"aa\" Returns: \"aa\"",
"\"abdfheca\" Returns: \"abdfheca\"",
"\"aaaaaaaaa\" Returns: \"aaaaaaaaa\"",
"\"uodoutivesbegckw\" Returns: \"ubdeiosuvtokgecw\"",
"\"zaabz\" Returns: \"zabaz\""
